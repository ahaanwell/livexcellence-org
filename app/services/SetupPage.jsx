                            ...
                            {view === "error" && (
                                <div className="py-4 sm:py-6 lg:py-8 px-4 sm:px-6 lg:px-10">
                                    <div className="text-center">
                                        ...
                                        <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-gray-900 mb-2">Download Failed</h3>
                                        <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 px-2">
                                            We encountered an issue during the Downloading process. Our technical team has been notified and will contact you shortly to resolve this issue.
                                        </p>
