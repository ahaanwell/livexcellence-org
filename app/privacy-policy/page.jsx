      ...
      <header className="bg-[#073e89] text-white pb-16 pt-28 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="mt-4 text-sky-200 max-w-3xl mx-auto text-base sm:text-lg md:text-xl leading-relaxed">
            Livexcellence (a wholly owned subsidiary of Livexcellence) is committed to ensuring your privacy at all times. This Privacy Policy explains how we collect, use, and share information when you use our websites, products, or services.
          </p>
        </div>
      </header>
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        <article className="prose prose-slate max-w-none lg:prose-lg xl:prose-xl">
          ...
          <p className="mb-4 leading-relaxed">
            This Privacy Policy governs the collection of information by Livexcellence across most of its websites and services, including offline product support. It does not apply to Livexcellence services that display their own distinct privacy statements. Please read carefully to understand how we gather, safeguard, and use your information.
          </p>
          <p className="mb-4 leading-relaxed">
          ...
          <p className="mb-4 leading-relaxed">
            Some ads may be served by third-party networks that place cookies to deliver targeted ads. Livexcellence does not control these cookies. Sharing content on social media may also involve cookies controlled by the respective platforms.
          </p>

          <h4 className="text-xl sm:text-2xl font-medium mt-6 mb-2">Placing Orders</h4>
          <p className="mb-4 leading-relaxed">
            Paid products are processed by third-party service providers. Billing and payment details (including credit card information) are collected by the provider. Information may be shared with Livexcellence for order verification, subscription updates, and promotions.
          </p>
          ...
          <h4 className="text-xl sm:text-2xl font-medium mt-6 mb-2">Livexcellence Forum</h4>
          <p className="mb-4 leading-relaxed">
          ...
          <p className="mb-4 leading-relaxed">
            Livexcellence collects hardware/software inventory to provide driver downloads and device recommendations. This data helps match optimal updates for systems and refine our intelligence for better recommendations.
          </p>
          ...
          <p className="mb-4 leading-relaxed">
            Livexcellence implements various security protocols including restricted access, encrypted transmissions (SSL), and responsible password management. Users are encouraged to maintain their account security and log out when sharing devices.
          </p>
          ...
          <p className="mb-4 leading-relaxed">
            For inquiries or concerns about this Privacy Policy or how Livexcellence handles personal information, please contact us through our website. We will investigate and respond promptly to any reported issues.
          </p>
        </article>
      </section>
    </main>
